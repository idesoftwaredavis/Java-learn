...
import control.FuncionarosControl;
 ...
 */
public class SFuncionarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Funcionarios f = new Funcionarios(id,nombre,apellido,ci,cargo,sueldo);
            
            if ( id == null ) {
                funcionariosControl.insertar(f);
            }else{
                if( request.getParameter("del")== null){
                    funcionariosControl.modificar(f);
                }else{
                    funcionariosControl.eliminar(f);
                }
